...
/**
 * Created by ichaeeun on 2017. 8. 15..
 */
...
public class PinchZoomImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    private final static float mMinZoom = 1.f; // 사진 줄일때 언제까지 작아지는지 비율. 1배수
    private final static float mMaxZoom = 3.f;  // 사진 늘릴때 어느 크기까지 . 3배수까지 커짐
